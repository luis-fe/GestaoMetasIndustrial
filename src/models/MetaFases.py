...
class MetaFases():
    ...
    def __init__(self, codPlano = None, codLote = None, nomeFase =None, dt_inicioRealizado = None, dt_fimRealizado = None, analiseCongelada = False, arrayCodLoteCsw = None,
        ...
        if self.arrayCodLoteCsw == ['25A04B'] or self.arrayCodLoteCsw == ['25O05A']  :
            self.consideraFaltaProgr = False
        ...
        if self.analiseCongelada == False:
            ...
            if diaAtual >= IniFat:
                sqlMetas['FaltaProgramar1'] = (
                                                      sqlMetas['previsao'] - sqlMetas['qtdeFaturada']-sqlMetas['qtdeCancelada'] ) - (
            ...
            # 6.2 caso o faturamento da colecao atual nao tenha iniciado
                ...
                sqlMetas['FaltaProgramar1'] = (sqlMetas['previsao']-sqlMetas['qtdeFaturada']-sqlMetas['qtdeCancelada']) - (sqlMetas['estoque-saldoAnt'] + sqlMetas['carga'])
...
'166106-001'
            ...
            realizadoPeriodo = ProducaoFases.ProducaoFases(self.dt_inicioRealizado, self.dt_fimRealizado, '', 0, self.codEmpresa, 100, 100, None,'','',self.arrayTipoProducao)
