...
class Gastos_centroCusto_CSW():
    ...
    def get_notasEntredas_Csw(self):
        ...
        consulta.drop(['index', 'level_0', 'mascaraEdt','codTransacao','centroCustovalor','codArea','ocorrencia_acumulada','seqItemDocumento'], axis=1, inplace=True)
    ...
    def __getContaContabil(self):
        ...
        data2 = {'codContaContabil':['3151','3201'],"nomeContaContabil":["Serviços de Industrialização",'MATÉRIA PRIMA'],"mascaraEdt":['-','-'],"GRUPO":['SERVIÇO INDUSTRIALIZACAO','MATÉRIA PRIMA']}
    ...
    def __getSalarios(self):
        ...
        WHERE
            m.codEmpresa = {self.codEmpresa}
            and m.codContaContabil in (3063, 3323, 3174)
